...
const chatbotKnowledge = {
  skills: `Bhaveek is skilled in:\n• **Frontend**: HTML5, CSS3, JavaScript, React.js, Next.js, Vue.js, TypeScript\n• **Backend**: Node.js, Express.js, Python, Django, Java, REST APIs\n• **Databases**: MongoDB, PostgreSQL, MySQL, Redis, Firebase\n• **DevOps/Tools**: Git, Docker, AWS, CI/CD, Linux\n• **Languages**: JavaScript, Python, Java, C/C++, TypeScript, C#`,
  projects: `Bhaveek has built several impressive projects:\n\n1. **E-Commerce Platform** — Full-stack (React, Node.js, MongoDB)\n2. **AI Sentiment Analyzer** — ML model with 94% accuracy (Python, TensorFlow)\n3. **Analytics Dashboard** — Real-time data visualization (Next.js, PostgreSQL)\n4. **Task Manager App** — Cross-platform mobile app (React Native, Firebase)\n5. **Microservices API Gateway** — Scalable backend (Node.js, Docker, Redis)\n6. **AI Chatbot System** — RAG-based chatbot (Python, OpenAI, LangChain)\n\nAll projects are available on [GitHub](https://github.com/Bhaveek08)`,
  experience: `Bhaveek's work experience:\n\n• **Software Developer** (2024–Present) — Full-stack development with React, Node.js, and AWS\n• **Full Stack Developer Intern** (2023–2024) — Built production features, improved performance by 40%\n• **Frontend Developer Intern** (2022–2023) — UI development, reduced load time by 35%`,
  contact: `You can reach Bhaveek at:\n\n📧 **Email**: tarushagrawal5@gmail.com\n🐙 **GitHub**: [github.com/Bhaveek08](https://github.com/Bhaveek08)\n💼 **LinkedIn**: linkedin.com/in/bhaveek\n📍 **Location**: India 🇮🇳\n\nBhaveek is currently **open to opportunities**!`,
  education: `Bhaveek's education:\n\n🎓 **B.Tech in Computer Science & Engineering** — CGPA: 8.5/10 (2020–2024)\n📚 **12th Grade (Science/PCM)** — 92% score (2018–2020)`,
  certifications: `Bhaveek holds certifications in:\n\n• AWS Certified Developer (Amazon Web Services, 2024)\n• Microsoft Azure Fundamentals (Microsoft, 2024)\n• Google Cloud Professional (Google Cloud, 2023)\n• Full Stack Web Development (Coursera/Meta, 2023)\n• Python for Data Science (IBM/Coursera, 2023)\n• Machine Learning Specialization (DeepLearning.AI/Stanford, 2022)`,
  about: `Bhaveek is a passionate **Full Stack Developer & Software Engineer** from India. He specializes in building scalable, user-friendly applications — from elegant front-end interfaces to robust back-end systems. He has 3+ years of experience, 15+ projects completed, and 10+ certifications.`,
  hire: `Bhaveek is **open to work**! He's available for:\n• Freelance projects\n• Full-time opportunities\n• Technical collaborations\n\nContact him at tarushagrawal5@gmail.com or visit the Contact section.`,
  github: `You can explore all of Bhaveek's open-source work at:\n🐙 [github.com/Bhaveek08](https://github.com/Bhaveek08)`
};
